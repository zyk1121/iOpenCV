...
- (void)viewDidLoad {
    ...
    [rollView setupScroollArray:imageArray isAutoRun:YES];
    ...
    YKScrollView *sv2 = [[YKScrollView alloc] initWithFrame:CGRectMake(0, 320, SCREEN_WIDTH, 180) andSubViewClass:[YKImageView class]];
    sv2.data = [NSMutableArray arrayWithObjects:@"1.jpg",@"2.jpg",@"3.jpg", nil];
    sv2.frame=CGRectMake(0, 320, SCREEN_WIDTH, 180);
//    [sv2 setupScroollArray:imageArray isAutoRun:NO];
    [self.view addSubview:sv2];
    
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        sv2.data = [NSMutableArray arrayWithObjects:@"1.jpg",@"2.jpg",@"3.jpg",@"4.jpg",@"1.jpg",@"2.jpg",@"3.jpg",@"4.jpg", nil];
